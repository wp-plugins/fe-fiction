...
add_filter('generate_rewrite_rules','FeFiction_Insert_Rewrite_Rules');
add_filter('query_vars', 'FeFiction_Insert_Rewrite_QueryVars' );
add_filter('init','FeFiction_FlushRules');
