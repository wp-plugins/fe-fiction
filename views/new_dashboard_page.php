<ul id="dashboard-cms">
	...
	<?php } else { ?>
		...
		<?php if(current_user_can('edit_posts')) { ?><li class="left-gray"><a href="post-new.php?post_type=fiction"><div id="icon-edit" class="icon32">&nbsp;</div><?php echo __('New Fiction Story','fe-fiction'); ?></a></li><?php } ?>
		<?php if(current_user_can('edit_posts')) { ?><li class="right-gray"><a href="edit.php?post_type=fiction"><div id="icon-edit" class="icon32">&nbsp;</div><?php echo __('Manage Fiction Stories','fe-fiction'); ?></a></li><?php } ?>

	<?php } ?>

	<?php if(current_user_can('edit_themes')) { ?><li class="left-gray"><a href="widgets.php"><div id="icon-themes" class="icon32">&nbsp;</div><?php echo __('Manage Widgets','fe-fiction'); ?></a></li><?php } ?>
	<?php if(current_user_can('edit_themes')) { ?><li class="right-gray"><a href="nav-menus.php"><div id="icon-themes" class="icon32">&nbsp;</div><?php echo __('Manage Menus','fe-fiction'); ?></a></li><?php } ?>
