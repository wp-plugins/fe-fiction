<div class="wrap">
	...
	<?php if($options_updated['success']) { ?><div id="message" class="updated below-h2"><p><?php echo __('FE Fiction options have been updated','fe-fiction'); ?></p></div><?php } ?>
	<?php if($options_updated['page_created_error'] != '') { ?><div id="error" class="error below-h2"><p><?php echo __('There were complications with page creation.  Please see message below.','fe-fiction'); ?></p></div><?php } ?>
	...
	<tr>
		...
		<td width="75%" style="vertical-align:top;">
			<?php if($options_updated['page_created']) { ?><div id="message" class="updated below-h2"><p><?php echo __('Page has been created for you','fe-fiction'); ?></p></div><?php } ?>
			<?php if($options_updated['page_deleted']) { ?><div id="message" class="updated below-h2"><p><?php echo __('Page has been deleted!  You may safely create a new page.','fe-fiction'); ?></p></div><?php } ?>

			<?php if(!$options_updated['page_created'] && $options_updated['page_created_error'] != '') { ?><div id="error" class="error below-h2"><p><?php echo $options_updated['page_created_error']; ?></p></div><?php } ?>		
			...
			<label><input name="create_fe_fiction_page" type="checkbox" id="create_fe_fiction_page" tabindex="1" value="1" <?php if(isset($_POST['create_fe_fiction_page']) && !$options_updated['page_created']) { ?>checked="checked"<?php } ?> /><?php echo __('Yes, Create the page for me','fe-fiction'); ?></label><br />
			<?php } ?>
	...
	<tr>
		...
		<td width="75%" style="vertical-align:top;"><?php if($options_updated['custom_dashboard_enabled']) { ?><div id="message" class="updated below-h2"><p><?php echo __('Override Dashboard option enabled','fe-fiction'); ?></p></div><?php } ?>
	...
	<tr>
	  ...
	  <td style="vertical-align:top;"><?php if($options_updated['hide_admin_menus_enabled']) { ?><div id="message" class="updated below-h2"><p><?php echo __('Admin menus are now hidden (except for admins)','fe-fiction'); ?></p></div><?php } ?>
	...
	<tr>
	  ...
	  <td style="vertical-align:top;"><?php if($options_updated['default_role_set']) { ?><div id="message" class="updated below-h2"><p><?php echo __('Default role has been set to Author','fe-fiction'); ?></p></div><?php } ?>
